...
class SettingsPage(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        profile_first_name_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350)
        profile_last_name_title = ctk.CTkLabel(self.profile_section, text="Last Name:", font=("", 18))
        profile_last_name_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350)
        profile_age_title = ctk.CTkLabel(self.profile_section, text="Age:", font=("", 18))
        profile_age_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350)
        profile_height_title = ctk.CTkLabel(self.profile_section, text="Height:", font=("", 18))
        profile_height_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350)
        profile_current_weight_title = ctk.CTkLabel(self.profile_section, text="Current Weight:", font=("", 18))
        profile_current_weight_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350)
        profile_goal_weight_title = ctk.CTkLabel(self.profile_section, text="Goal Weight:", font=("", 18))
        profile_goal_weight_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350)
