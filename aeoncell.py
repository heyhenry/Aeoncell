...
class Navbar(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        self.dashboard_icon.bind("<Enter>", lambda event: self.display_underline(self.dashboard_title))
        self.dashboard_icon.bind("<Leave>", lambda event: self.undisplay_underline(self.dashboard_title))
        self.dashboard_title.bind("<Enter>", lambda event: self.display_underline(self.dashboard_title))
        self.dashboard_title.bind("<Leave>", lambda event: self.undisplay_underline(self.dashboard_title))
        self.discover_icon.bind("<Enter>", lambda event: self.display_underline(self.discover_title))
        self.discover_icon.bind("<Leave>", lambda event: self.undisplay_underline(self.discover_title))
        self.discover_title.bind("<Enter>", lambda event: self.display_underline(self.discover_title))
        self.discover_title.bind("<Leave>", lambda event: self.undisplay_underline(self.discover_title))
        self.entry_icon.bind("<Enter>", lambda event: self.display_underline(self.entry_title))
        self.entry_icon.bind("<Leave>", lambda event: self.undisplay_underline(self.entry_title))
        self.entry_title.bind("<Enter>", lambda event: self.display_underline(self.entry_title))
        self.entry_title.bind("<Leave>", lambda event: self.undisplay_underline(self.entry_title))
        self.stats_icon.bind("<Enter>", lambda event: self.display_underline(self.stats_title))
