...
class BaseEntryPage(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        type_title.grid(row=2, column=1, padx=20)
        self.type_entry.grid(row=3, column=1, padx=20)
        exercise_name_title.grid(row=2, column=2, padx=20)
        self.exercise_name_entry.grid(row=3, column=2, padx=20)
        date_title.grid(row=4, column=1, padx=20)
        self.date_entry.grid(row=5, column=1, padx=20)
        time_title.grid(row=4, column=2, padx=20)
        self.time_entry.grid(row=5, column=2, padx=20)
        sets_title.grid(row=6, column=1, padx=20)
        self.sets_entry.grid(row=7, column=1, padx=20)
        reps_title.grid(row=6, column=2, padx=20)
        self.reps_entry.grid(row=7, column=2, padx=20)
        weight_title.grid(row=8, column=1, padx=20)
        self.weight_entry.grid(row=9, column=1, padx=20)
        label_title.grid(row=8, column=2, padx=20)
        self.label_entry.grid(row=9, column=2, padx=20)
        self.error_message.grid(row=10, column=1, columnspan=2, pady=5, padx=20)
        self.add_exercise_btn.grid(row=11, column=1, padx=20)
        self.redirect_btn.grid(row=11, column=2, padx=20)
