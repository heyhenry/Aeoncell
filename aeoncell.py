...
class SettingsPage(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        profile_last_name_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350, textvariable=self.profile_last_name_var)
        profile_age_title = ctk.CTkLabel(self.profile_section, text="Age:", font=("", 18))
        profile_age_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350, textvariable=self.profile_age_var)
        profile_height_title = ctk.CTkLabel(self.profile_section, text="Height:", font=("", 18))
        profile_height_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350, textvariable=self.profile_height_var)
        profile_current_weight_title = ctk.CTkLabel(self.profile_section, text="Current Weight:", font=("", 18))
        profile_current_weight_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350, textvariable=self.profile_current_weight_var)
        profile_goal_weight_title = ctk.CTkLabel(self.profile_section, text="Goal Weight:", font=("", 18))
        profile_goal_weight_entry = ctk.CTkEntry(self.profile_section, font=("", 24), width=350, textvariable=self.profile_goal_weight_var)
        ...
        daily_sleep_entry = ctk.CTkEntry(self.daily_goals_section, font=("", 24), width=350, textvariable=self.daily_sleep_var)
        daily_walking_title = ctk.CTkLabel(self.daily_goals_section, text="Walking (Steps):", font=("", 24))
        daily_walking_entry = ctk.CTkEntry(self.daily_goals_section, font=("", 24), width=350, textvariable=self.daily_walking_var)
        daily_hydration_title = ctk.CTkLabel(self.daily_goals_section, text="Hydration (L):", font=("", 24))
        daily_hydration_entry = ctk.CTkEntry(self.daily_goals_section, font=("", 24), width=350, textvariable=self.daily_hydration_var)
