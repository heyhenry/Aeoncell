...
class DashboardPage(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        profile_height_frame = ctk.CTkFrame(profile_info_section, border_width=3, border_color="#A259FF", corner_radius=15, width=100, height=50, fg_color="transparent")
        ...
        profile_weight_frame = ctk.CTkFrame(profile_info_section, border_width=3, border_color="#A259FF", corner_radius=15, width=100, height=50, fg_color="transparent")
        ...
        profile_age_frame = ctk.CTkFrame(profile_info_section, border_width=3, border_color="#A259FF", corner_radius=15, width=100, height=50, fg_color="transparent")
        profile_age_display = ctk.CTkLabel(profile_age_frame, text="43yo", font=("", 18))
        profile_monthly_section = ctk.CTkFrame(profile_section, border_color="blue", border_width=1, fg_color="transparent")
