...
class BaseEntryPage(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        self.entry_form = ctk.CTkFrame(content, fg_color=("#F5F0FF", "#2A1A4A"), width=514, height=700, border_color=("#B19CD9", "#9370DB"), border_width=5, corner_radius=40)
        ...
        self.date_entry = ctk.CTkEntry(self.entry_form, width=200, font=("", 24))
        time_title = ctk.CTkLabel(self.entry_form, text="Time (hh:mm)*:", font=("", 24))
        self.time_entry = ctk.CTkEntry(self.entry_form, width=200, font=("", 24))
        label_title = ctk.CTkLabel(self.entry_form, text="Label:", width=300, font=("", 24))
        self.label_entry = ctk.CTkEntry(self.entry_form, width=300, font=("", 24))
        sets_title = ctk.CTkLabel(self.entry_form, text="Sets*:", font=("", 24))
        self.sets_entry = ctk.CTkEntry(self.entry_form, width=200, font=("", 24))
        reps_title = ctk.CTkLabel(self.entry_form, text="Reps*:", font=("", 24))
        self.reps_entry = ctk.CTkEntry(self.entry_form, width=200, font=("", 24))
        ...
        page_title.grid(row=1, column=1, columnspan=2, padx=20)

        type_title.grid(row=2, column=1, columnspan=2, pady=(10, 0), padx=20)
        self.type_entry.grid(row=3, column=1, columnspan=2, pady=(5, 0), padx=20)
        exercise_name_title.grid(row=4, column=1, columnspan=2, pady=(10, 0), padx=20)
        self.exercise_name_entry.grid(row=5, column=1, columnspan=2, pady=(5, 0), padx=20)
        date_title.grid(row=6, column=1, pady=(10, 0), padx=20)
        self.date_entry.grid(row=7, column=1, pady=(5, 0), padx=20)
        time_title.grid(row=6, column=2, pady=(10, 0), padx=20)
        self.time_entry.grid(row=7, column=2, pady=(5, 0), padx=20)
        label_title.grid(row=8, column=1, columnspan=2, pady=(10, 0), padx=20)
        self.label_entry.grid(row=9, column=1, columnspan=2, pady=(5, 0), padx=20)
        sets_title.grid(row=10, column=1, pady=(10, 0), padx=20)
        self.sets_entry.grid(row=11, column=1, pady=(5, 0), padx=20)
        reps_title.grid(row=10, column=2, pady=(10, 0), padx=20)
        self.reps_entry.grid(row=11, column=2, pady=(5, 0), padx=20)
        weight_title.grid(row=12, column=1, columnspan=2, pady=(10, 0), padx=20)
        self.weight_entry.grid(row=13, column=1, columnspan=2, pady=(5, 0), padx=20)
        self.error_message.grid(row=14, column=1, columnspan=2, pady=5, padx=20)
        self.add_exercise_btn.grid(row=15, column=1, pady=(0, 50), padx=20)
        self.redirect_btn.grid(row=15, column=2, pady=(0, 50), padx=20)
