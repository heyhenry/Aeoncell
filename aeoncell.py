...
class DashboardPage(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        profile_monthly_weight_progressbar = ctk.CTkProgressBar(profile_monthly_section, border_width=2, height=30, width=350)
        ...
        profile_sleep_progressbar = ctk.CTkProgressBar(profile_monthly_section, border_width=2, height=30, width=350)
        ...
        profile_hydration_progressbar = ctk.CTkProgressBar(profile_monthly_section, border_width=2, height=30, width=350)
        ...
        sleep_icon = ctk.CTkLabel(sleep_icon_reset_frame, text="", image=self.sleep_icon)
        ...
        hydration_icon = ctk.CTkLabel(hydration_icon_reset_frame, text="", image=self.hydration_icon)
        ...
        walking_icon = ctk.CTkLabel(walking_icon_reset_frame, text="", image=self.walking_icon)
